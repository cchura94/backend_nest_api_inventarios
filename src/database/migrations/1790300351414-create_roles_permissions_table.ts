...
export class CreateRolesPermissionsTable1790300351414 implements MigrationInterface {
    name = 'CreateRolesPermissionsTable1790300351414'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "permission" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "label" character varying, "action" character varying NOT NULL, "subject" character varying NOT NULL, CONSTRAINT "PK_3b8b97af9d9d8807e41e6f48362" PRIMARY KEY ("id"))`);
